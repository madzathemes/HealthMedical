...
?>
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php if (!is_single()){?>	
			...
			<?php if (! is_search()){ ?><i class="ti-receipt mt-blog-icon"></i><?php } ?>
			<?php if ( is_single() ) : ?>
			...
			<?php if (! is_search()){ ?><?php if(ot_get_option("blog_meta_on")!="off") {  twentytwelve_entry_meta(); } ?><?php }?>
			
		</header><!-- .entry-header -->
		<?php } ?>
				<?php if( ! is_search()) {  if ( has_post_thumbnail() ) : ?>
			<div class="entry-page-image">
				<div class="flexslider mt<?php echo esc_attr(get_the_ID()); ?>"> 
					<ul class="slides">
							...
							<li><a href="<?php the_permalink(); ?>"><span class="dark-background-2"></span><?php 
								...
								echo get_the_post_thumbnail( get_the_ID(), array($mt_image_width, $height, 'bfi_thumb' => true) );
							?></a></li>
		...
		<footer class="entry-meta"><?php  
			...
			if( ! is_search()) {  if( ! is_single()) { echo "<a href='".get_permalink()."' class='more-link'><span>"; _e( 'Read more', 'twentytwelve' );  echo "</span></a>"; } }
