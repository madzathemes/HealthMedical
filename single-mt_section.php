...
?><section data-type="background"  data-speed="<?php if(get_post_meta(get_the_ID(), "mt_paralex_speed", true)!="" and get_post_meta(get_the_ID(), "mt_paralex_speed_on", true)!="no"){ echo esc_attr(get_post_meta(get_the_ID(), "mt_paralex_speed", true)); }?>" class="mt-boxed-version mt-style-<?php echo esc_attr(get_the_ID()); ?> <?php echo esc_attr($class); ?>" ><div class="mt-section-bg mt-section-bg-<?php echo esc_attr(get_the_ID()); ?>"></div><div class="container"><div class="row"><div class="col-md-12"><?php the_content(); ?></div></div></div></section>
