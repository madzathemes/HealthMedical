...
vc_add_param("vc_row", array(
	"type" => "textfield",
	"class" => "",
	"heading" => "Video Top Margin Fix",
	"value" => "-100px",
	"param_name" => "video_fix",
	"description" => "",
	"dependency" => Array('element' => "video", 'value' => array('show_video'))
));
vc_add_param("vc_row", array(
...
vc_add_param("vc_row", array(
	...
	"param_name" => "mt_bg_type",
	"value" => array(
		"Default" => "mt-bg-default",
		"Cover" => "mt-bg-cover",
		"Containt" => "mt-bg-contain",
		"No-Repeat" => "mt-bg-norepeat",
		"Repeat" => "mt-bg-repeat",
		"Top Center" => "mt-bg-topcenter",
		"Bottom Center" => "mt-bg-bottomcenter"
	),
	"description" => "",
	"dependency" => Array('element' => "row_type", 'value' => array('row'))
));
