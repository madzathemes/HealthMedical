...
<div class="glass-row glass-<?php echo get_post_meta($post->ID, "mt_page_slider_color", true); ?>" >
...
if($myposts!="") {
	...
	foreach($myposts as $post){ 
		...
		$images .= '<img src="'. bfi_thumb($post['image'], array( 'width' => 1140, 'height' => $slider_height ) ) .'" alt="" >';
...
<div class="glass-general-frame" style="height:<?php echo $slider_height; ?>px;">
    ...
    <div class="glass-hover-2" style="height:<?php echo $slider_height; ?>px;">
        ...
        <div class="glass-content-scroll"  data-cycle-slides="> div" style="height:<?php echo $slider_height; ?>px;">
...
<div class="glass-slider-frame" style="height:<?php echo $slider_lr_height; ?>px; margin-top:-410px;">
    ...
    <div class="glass-slider-item" style=" margin-top:<?php echo $slider_lr_top; ?>px;">
        ...
        <div class="glass-slider-frame-position-1">
            ...
            <div class="glass-slider-frame-in" style="height:<?php echo $slider_lr_height; ?>px;">
                ...
                <div class="glass-left-frame" style="height:<?php echo $slider_lr_height; ?>px; ">

                    <div class="glass-frame-hover-1">

                        <div class="glass-slide-1" style="height:<?php echo $slider_lr_height; ?>px;">
        ...
        <div class="glass-slider-frame-position-3">
            ...
            <div class="glass-slider-frame-in">
                ...
                <div class="glass-right-frame"  style="height:<?php echo $slider_lr_height; ?>px; ">

                    <div class="glass-frame-hover-3">

                        <div class="glass-slide-3" style="height:<?php echo $slider_lr_height; ?>px; ">
