							...
							if($categorys=="Select..." OR $categorys=="All" OR $categorys=="" ){
								...
								$term_obj = get_terms('portfolio_cat'); ?>
									<ul id="filterm">
										...
										<?php foreach ($term_obj as $term) { ?><li><a href="#"  <?php if ($term->slug == 'photos') {?> class="show-subnav filter-item" <?php } else {?>class="close-subnav filter-item" <?php }?>id="<?php echo esc_attr($term->slug); ?>" data-filter=".<?php echo esc_attr($term->slug); ?>"><?php echo esc_attr($term->name); ?></a></li><?php } ?>
									</ul>
									<div class="clear"></div>
						<?php }
					}
 ...
 */
	function twentytwelve_entry_meta() {
		...
		if ( $tag_list ) {
			$utility_text = __( '<div class="mt-meta"><i class="fa fa-folder-open-o"></i> %1$s - <i class="fa fa-tag"></i> %2$s - <i class="fa fa-calendar"></i> %3$s </div>', 'madza_translate' );
		} elseif ( $categories_list ) {
			$utility_text = __( '<div class="mt-meta"><i class="fa fa-folder-open-o"></i> %1$s - <i class="fa fa-calendar"></i> %3$s </div>', 'madza_translate' );
		} else {
			$utility_text = __( '<div class="mt-meta">Posted on <i class="fa fa-calendar"></i> %3$s </div>', 'madza_translate' );
		}
