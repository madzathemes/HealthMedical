...
<div class="row">
			...
			<div class="flexslider fslider"> 
				...
				<ul class="slides">
					...
					<?php } else if(has_post_thumbnail()) { ?>
						...
						<li><?php  echo get_the_post_thumbnail( get_the_ID(), array(750, $mt_portfolio_slider_height, 'bfi_thumb' => true), $src[0] );?></li>
	...
	<div class="col-md-4 <?php echo esc_attr($mt_float_sidebar); echo esc_attr($col_4); ?> ">
